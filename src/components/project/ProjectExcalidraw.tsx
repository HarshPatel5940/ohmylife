...
export function ProjectExcalidraw({
  ...
  const handleDeleteDrawing = async () => {
    ...
    setDeleting(true);
    try {
      const res = await fetch(`/api/projects/${projectId}/excalidraw/${drawingToDelete}`, {
        method: "DELETE",
      });
            ...
            {drawings.map((drawing) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <h4 className="font-medium truncate flex-1">{drawing.name}</h4>
                  <Button variant="ghost" size="sm" onClick={() => openDrawing(drawing.id)}>
                ...
                <div className="text-xs text-gray-500 mb-3">
                  ...
                  <p>Updated: {new Date(drawing.updatedAt).toLocaleDateString()}</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => openDeleteDialog(drawing.id)}>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleDeleteDrawing} disabled={deleting}>
