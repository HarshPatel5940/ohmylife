          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {loading ? (
              ...
              filteredProjects.map((project) => (
                <Card
                  key={project.id}
                  className="hover:shadow-lg transition-shadow h-full relative group"
                >
                  <Link
                ...
                <Card key={client.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <Badge variant="outline">{getClientProjectCount(client.id)} Projects</Badge>
                      <Badge
                        variant="secondary"
        ...
        <TabsContent value="people" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredPeople.length === 0 ? (
              <div className="col-span-full text-center py-12 text-gray-500">No people found</div>
            ) : (
      ...
      <Dialog open={clientDialogOpen} onOpenChange={setClientDialogOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingClient
                ? `Manage information for ${editingClient.name}`
              ...
              <TabsContent value="projects" className="space-y-4 pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    size="sm"
                    onClick={() =>
                      router.push(`/dashboard/projects/new?clientId=${editingClient.id}`)
                    }
                  >
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <form onSubmit={handleSavePerson}>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="personEmail" className="text-right">
                  Email
                </Label>
                <Input
                  id="personEmail"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="personPhone" className="text-right">
                  Phone
                </Label>
                <Input
                  id="personPhone"
